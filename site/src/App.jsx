...
const installOptions = [
  ...
  },
  {
    id: "gemini",
    label: "Gemini CLI",
    command: "gemini extensions install https://github.com/vishesh9131/elephant --ref=v0.2.0",
    note: "Loads Elephant's project context and resume skill.",
  },
  {
    id: "pi",
    label: "Pi",
    command: "pi install git:github.com/vishesh9131/elephant@v0.2.0",
      ...
      <section className="hero page-shell" aria-labelledby="hero-heading">
        <div className="hero__copy">
          ...
          <div className="hero__meta" aria-label="Project metadata">
            <span>V0.2.0</span><span>MIT LICENSE</span><span>LOCAL-FIRST</span>
          </div>
        </div>
